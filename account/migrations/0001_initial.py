    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classs', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='account.classes')),
            ],
        ),
        migrations.CreateModel(
            name='Teachers',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('Classes', models.ManyToManyField(blank=True, to='account.Classes')),
                ('Subjects', models.ManyToManyField(blank=True, to='account.Subjects')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('classs', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='account.classes')),
            ],
        ),
        migrations.CreateModel(
            name='Principal',
